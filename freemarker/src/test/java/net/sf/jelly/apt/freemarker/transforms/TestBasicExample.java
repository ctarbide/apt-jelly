 ...
 * @author Ryan Heaton
 */
public class TestBasicExample extends FreemarkerTestCase {

  public void testBasicExample() throws Exception {
    runScript("testBasicExample.fmt");
...
//    assertEquals(assertedResults.size(), results.size());
    for (Object key : assertedResults.keySet()) {
      assertEquals(key.toString(), assertedResults.get(key), results.get(key));
    }
  }
