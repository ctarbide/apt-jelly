 ...
 * @author Ryan Heaton
 */
public class TestForAllMethodsTag extends APTJellyTest {
  ...
  public void testIncludeSuperclasses() throws Exception {
    runScript("testIncludeSuperclasses.jelly");
  ...
  public void testIncludeSuperinterfaces() throws Exception {
    runScript("testIncludeSuperinterfaces.jelly");
  ...
  public void testPropertyName() throws Exception {
    runScript("testPropertyName.jelly");
